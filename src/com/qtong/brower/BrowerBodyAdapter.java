...
public class BrowerBodyAdapter extends BaseAdapter {

	private List<String> item_names;
	private List<Integer> item_images;
	private Context context;

	public BrowerBodyAdapter(Context context, List<String> item_names,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		tv_item.setPadding(20, 20, 20, 20);
		...
		img_item.setLayoutParams(new LayoutParams(80, 80));
